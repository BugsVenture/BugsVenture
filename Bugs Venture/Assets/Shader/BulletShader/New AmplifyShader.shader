...
Shader "New AmplifyShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( float4(1,0.2028302,0.290698,0) + fresnelNode1 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=15301
277;208;988;688;595;685;1;True;False
